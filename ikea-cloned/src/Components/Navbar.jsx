...
let navigate= useNavigate();
      ...
      <Box>
        ...
        >
          ...
          <DrawerContent>
            ...
            <DrawerBody>
              <Box>
            <Heading fontSize={"20px"} display="flex" gap={"20px"}> <CgProfile /> Hei! Log in or Sign up </Heading>
  ...
  {/* stack ---login or cart and delivery  */}
      <Box>
        <HStack gap={7}>
          <Button leftIcon={<CgProfile />} colorScheme="teal" variant="solid" display={{base:"none" , lg:"block"}}>
