...
const Signup = () => {
  ...
  const getAdd = async (formInputObj) => {
    let res = await fetch(`https://smart-shop-render.onrender.com/users`, {
      ...
      body: JSON.stringify(formInputObj),
    });
          ...
          <Stack spacing={4}>
            ...
            <FormControl id="mobile" isRequired>
              ...
              <Input
                ...
                value={formInputObj.mobile_number}
              />
            </FormControl>
