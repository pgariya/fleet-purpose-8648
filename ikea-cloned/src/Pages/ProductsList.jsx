...
import { Box, Button, Card, CardBody,  Heading, HStack, Image, SimpleGrid, Skeleton} from '@chakra-ui/react'
...
<Box py={10}>
  ...
  <Button bg={"red"}  color="white" onClick={handleALlData}>All</Button>
  <Button bg={"red"} color="white" onClick={handleBedroomData} >Bedroom</Button>
  <Button bg={"red"} color="white" onClick={handleLivingData}>Living room</Button>
  <Button bg={"red"} color="white" onClick={handleKitchenData} >Kitchen</Button>
  <Button bg={"red"} color="white" onClick={handleWorkSpaceData} >Workspace</Button>
  <Button bg={"red"}  color="white"onClick={handleOutdoorData} >Outdoor</Button>
  <Button bg={"red"} color="white" onClick={handleBathroomData} >Bathroom</Button>
  <Button bg={"red"} color="white" onClick={handleChildrenData} >Baby & children room</Button>
...
<Card  borderRadius='10px' bg={'white'} key={el.id} >
  ...
  <Image src={el.img} alt="croww" borderRadius={10} w="100%" transition={"transform 2s"} _hover={{transform: "scale(1.1)"}} />
